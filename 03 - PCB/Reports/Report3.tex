...
\label{Tab:Specs}
    \begin{tabular}{|l|l|l|}
      ...
      $V_\mathrm{out}$ &  & \si{\volt} \\ \hline
      $\Delta V_\mathrm{out,pp,rel}$ & 2 & \% \\ \hline
      $f_\mathrm{sw}$ & & \qty{}{\kHz} \\ \hline
...
\begin{table}[H]
    ...
    \include{List_of_Available_Components/List_of_Cap}
\end{table}

% \begin{table}[]
%     \centering
%     \label{tab:my_label}
%     \include{List_of_Available_Components/List_of_Cap_2}
% \end{table}
\clearpage
...
\include{List_of_Available_Components/List_of_Res}
\end{table}
...
\label{tab:SMD_Resistors}
\include{List_of_Available_Components/List_of_Shunt}
\end{table}
